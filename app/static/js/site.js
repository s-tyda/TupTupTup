...
const nowySekrecikOdStaszka = () => {
    if(document.getElementById("jd").classList.contains("jebac_disa")) {
        playAudio("static/audio/jd.mp3", false);
...
const getImage = function () {
    ...
    return new function() {
        console.log("XD");
        let img = "./static/images/memes/";
        const randomIndex = Math.floor(Math.random() * imageURLs.length);
        img += imageURLs[randomIndex];
        imgContainer.src = img;
        if (img === "./static/images/memes/86.jpg"){
            unlockSecret();
        }
    }
}
...
const initKotyraEgg = function () {
    ...
    playAudio("static/audio/xcq.mp3", true);
    addRandomImage("static/images/randomKotyra.jpg");
    addRandomImage("static/images/backgrounds/chinaFlag.jpg");
...
const setBackgroundFlagForButtons = function () {
    document.querySelectorAll(".but").forEach(el => {
        ...
        el.style.backgroundImage = "url('static/images/backgrounds/chinaFlag.jpg')";
...
const addBlinkingBackground = function () {
    ...
    document.body.style.backgroundImage = "url('static/images/backgrounds/borzecki.jpg')"
